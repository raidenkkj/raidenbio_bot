...
async def start_message(RaidenBot, message):
    await RaidenBot.send_photo(message.chat.id, photo=".images/profile_picture.png", caption="*_Hello, this is still in development, please try again later!_*", parse_mode='MarkdownV2')
